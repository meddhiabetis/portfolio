...
const certs = [
  ...
  },
  {
    ...
    date: 'Aug 2024',
    logo: '/images/logos/deeplearningai.png',
  },
  {
  ...
  },
  {
    ...
    issuer: 'DataCamp',
    date: 'May 2024',
    logo: '/images/logos/datacamp.png',
  },
  {
  ...
  {
    title: 'Databases and SQL for DS with Python',
    issuer: 'IBM',
    date: 'Mar 2024',
  ...
  {
    title: 'Preprocessing for ML in Python',
    issuer: 'DataCamp',
    date: 'Dec 2023',
    logo: '/images/logos/datacamp.png',
  },
  ...
  {
    title: 'R Programming Intermediate',
    issuer: 'DataCamp',
    date: 'Sep 2023',
    logo: '/images/logos/datacamp.png',
  },
            ...
            {certs.map((c, idx) => (
              <div key={`${c.title}-${c.date}`} className="card p-4 w-[380px]">
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative w-24 h-16 shrink-0 rounded-lg flex items-center justify-center bg-white dark:bg-white ring-1 ring-black/10 shadow-sm">
                    <Image
                      src={c.logo}
                      alt={c.issuer}
                      fill
